  ...
  secoes: [
    {
      ...
      paragrafos: [
        ...
        "Seu personal vê os seus dados. Nenhum outro aluno vê o seu treino, o seu histórico nem o seu perfil.",
    ...
    },
    {
      ...
      paragrafos: [
        "Peso, altura e data de nascimento, junto com o que você levanta, dizem coisas sobre seu corpo. Foto de treino, mais ainda. A lei brasileira (LGPD) chama isso de **dado pessoal sensível** e exige cuidado maior — inclusive o seu consentimento explícito, que é o que você dá ao aceitar esta política no primeiro acesso.",
    ...
    },
    {
      ...
      paragrafos: [
        "Para seu personal montar e ajustar seu treino. Para você ver seu histórico, seus recordes e sua evolução por exercício. Para o app saber qual treino sugerir hoje. Para mostrar no feed o que você publicou, para quem você escolheu.",
    ...
    },
    {
      ...
      paragrafos: [
        "**Seu personal**, o mesmo que te convidou: vê seu perfil, seus treinos, todo o seu histórico de execução e tudo o que você publica no feed, inclusive os posts marcados como “só o seu personal”. É o ponto do produto — ele precisa disso para te treinar.",
        "**Os outros alunos do seu personal**, e apenas eles, veem os posts que você marcou para a turma: a foto, a legenda, os comentários e a contagem de curtidas. Nada mais seu: nem perfil, nem peso, nem treino, nem histórico. Você também vê os posts que eles marcaram para a turma.",
    ...
    },
    {
      ...
      paragrafos: [
        ...
        "Quando você pedir exclusão da conta, apagamos tudo em até 30 dias — perfil, treinos, todas as séries registradas, seus posts e todas as suas fotos. Não guardamos cópia depois disso.",
      ],
    },
    {
      ...
      paragrafos: [
        ...
        "Boa parte disso você já faz sozinho no app: seu perfil e seu histórico estão todos lá, o perfil é editável, e cada post tem o botão de apagar.",
    ...
    },
    {
      titulo: "Segurança",
      paragrafos: [
        "O acesso é por senha, e todo tráfego é cifrado. No banco, cada linha tem regra de quem pode ler e escrever, conferida pelo próprio banco a cada consulta — não por código de tela, que é onde esse tipo de regra costuma falhar. As fotos seguem a mesma lógica: a permissão do arquivo espelha a do post.",
